...
public partial class SimpleAnimationPlayable : PlayableBehaviour
{
    ...
    {
        #region Event
        public EventHandler<EventArgs> OnEnd = null;

        private void TestEnd(object sender, EventArgs e)
        {
        ...
        public void Initialize(StateInfoScriptableObject scriptable)
        {
            m_StateName = scriptable.stateName;
            m_Clip = scriptable.clip;
            m_WrapMode = scriptable.wrapMode;

            m_AnimationEvents = scriptable.animationEvents;
        }
        ...
        public void Pause(bool isInit = true)
        {
        ...
        private AnimationClipEvent[] m_AnimationEvents;
